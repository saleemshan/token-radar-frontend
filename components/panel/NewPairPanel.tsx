...
import useTrendingNewPairTokensData from '@/hooks/data/useTrendingNewPairTokensData'
...
const NewPairPanel = ({
    ...
    const { data: trendingTokensData, error, isError } = useTrendingNewPairTokensData(chain.api, activeInterval)
        ...
        () => [
                ...
                cell: info => {
                    ...
                    return (
                        <div className="flex items-center gap-2 px-3 py-2">
                            <FavouriteTokenButton tokenData={tokenData} stopPropagation />
            ...
            columnHelper.accessor(row => row, {
                ...
                cell: info => {
                    ...
                    return (
                        <div
                            className={`p-3 text-center flex flex-col items-center justify-center gap-1  ${size === 'extra-small' ? 'text-xs' : ''}
              ${size === 'small' ? 'text-sm' : ''} 
    ...
    return (
        <div className=" w-full flex flex-col gap-2 max-h-full overflow-hidden h-full bg-black relative rounded-lg">
            <div
            ...
            >
                <div
                    className={`flex  px-3  gap-3  flex-wrap items-center  justify-between md:items-center min-h-[3.5rem] max-h-[3.5rem] md:min-h-14 md:max-h-14  border-b border-border`}
                >
                    <div className="flex flex-row gap-3 items-center flex-wrap">
                        {/* <MobileReturnButton label="New Pairs" /> */}
                        {showHeader && <div className=" text-sm font-semibold leading-6 text-white  bg-black hidden md:block">New Pairs</div>}
                            ...
                            {intervals.map(interval => {
                                return (
                                    <button
                                        ...
                                        className={`flex text-nowrap items-center justify-center text-xs py-1 hover:bg-neutral-800 duration-200 transition-all h-8 w-10   px-3 rounded-md font-semibold  ${
                ...
                <div className="w-full overflow-y-auto mobile-no-scrollbar relative h-full " ref={tableContainerRef}>
